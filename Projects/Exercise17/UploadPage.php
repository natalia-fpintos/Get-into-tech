    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <form id="form" action="UploadPage.php" method="POST" enctype="multipart/form-data" class="d-flex flex-column align-items-end col-sm-5">
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="uploaded_file" id="uploadedFile"/>
                            <label class="custom-file-label" for="uploadedFile" id="label">Choose an XML file</label>
                        </div>
                    </div>
            ...
            <div id="callout" class="row justify-content-center">
                ...
                if (!empty($_FILES[InputFileName])) {
                    ...
                    if ($_FILES[InputFileName]['name'] === '' && $_FILES[InputFileName]['type'] === '') {
                        ...
                        echo "<div class='callout error rounded m-3 p-3 col-sm-5'>
                                The file type is invalid. Please upload an XML file.
                              </div>";
